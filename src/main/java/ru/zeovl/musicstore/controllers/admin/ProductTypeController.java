...
@Controller
@RequestMapping("/admin/product_types")
public class ProductTypeController {
    ...
    String newProductType(Model model) {
        ...
        return "admin/product_type/product_type_form";
    }
    ...
    String getProductTypeById(@PathVariable int id, Model model) {
        ...
        return "admin/product_type/product_type_detail";
    }
    ...
    String confirmDeletingProductTypeById(@PathVariable int id, Model model) {
        ProductType productType = productTypeService.findById(id);
        model.addAttribute("productType", productType);
        return "admin/product_type/product_type_delete_confirmation";
    }
